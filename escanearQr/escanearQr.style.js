...
.escanearQr .escaneeElCodigoDelPaciente {
    position: absolute;
      box-sizing: content-box;
      -ms-transform: rotate(0.00deg);
    -webkit-transform: rotate(0.00deg);
...
.escanearQr .logoclinicauniversidaddelasabana250x90 {
    position: absolute;
      box-sizing: content-box;
      -ms-transform: rotate(0.00deg);
    -webkit-transform: rotate(0.00deg);
...
;
`;
cssText = cssText.replace(/background-image: url\(\"assets/g, `background-image: url("${import.meta.url.replace('escanearQr.style.js', 'assets')}`);
cssText = cssText.replace(/src: url\(assets/g, `src: url(${import.meta.url.replace('escanearQr.style.js', 'assets')}`);
export const EscanearQrStyle = html`
${cssText}
`;
